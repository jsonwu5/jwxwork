...
!(function (e, t) {
    ...
    if (!e.jWeixin) {
        var n,
            ...
            m = { initStartTime: x(), initEndTime: 0, preVerifyStartTime: 0, preVerifyEndTime: 0 },
            v = {
                version: '1.0.0',
                appId: '',
                initTime: 0,
        ...
        var w = {
                ...
                B(
                    i.onMenuShareQQ,
                    {
                        complete: function () {
                            C(
                                'shareQQ',
                                { title: e.title || r, desc: e.desc || '', img_url: e.imgUrl || '', link: e.link || location.href },
                                e,
                            );
                        },
                    },
            ...
            startBluetoothDevicesDiscovery: function (e) {
                C(
                    ...
                    { services: e.services || [], allowDuplicatesKey: e.allowDuplicatesKey || !1, interval: e.interval || 0 },
                    e,
                );
            },
            ...
            readBLECharacteristicValue: function (e) {
                C(
                    ...
                    { deviceId: e.deviceId, serviceId: e.serviceId, characteristicId: e.characteristicId },
                    e,
                );
            },
            ...
            writeBLECharacteristicValue: function (t) {
                ...
                (t.value = (function (t) {
                    ...
                    C(
                        ...
                        { deviceId: t.deviceId, serviceId: t.serviceId, characteristicId: t.characteristicId, value: t.value },
                        t,
                    );
            },
            notifyBLECharacteristicValueChange: function (e) {
                C(
                    ...
                    { deviceId: e.deviceId, serviceId: e.serviceId, characteristicId: e.characteristicId, state: e.state },
                    e,
                );
            },
